...
ADMINS = (
    # ('Your Name', 'your_email@BeanCatWorks.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'BeanCatWorks.db'),  # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'BeanCatWorks.urls'
